    ...
    Private Sub Admin_Contacts_Load(sender As Object, e As EventArgs) Handles Me.Load
        Using db As New DataClassesDataContext
            ...
            For Each c As TblContact In contacts
                dataTable.AddTableItem(c.ContactID.ToString("00000"), ContactTypeToString(c.ContactType), c.ContactName.Trim, c.Website.Trim, "<i class=""" & c.FaIcon.Trim & """></i>", BoolStatusToString(c.Status),
