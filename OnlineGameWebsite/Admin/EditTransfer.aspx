<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="EditTransfer.aspx.vb" Inherits="Admin_EditTransfer" %>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-sm-5 mb-3 mb-sm-0">
                                    <label>ID</label><br />
                                    <label>From Product</label><br />
                                    <label>From User Name</label><br />
                                    <label>To Product</label><br />
                                    <label>To User Name</label><br />
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <label id="lblFromProduct" runat="server">#Product</label><br />
                                    <label id="lblFromUsername" runat="server">#ProductUsername</label><br />
                                    <label id="lblToProduct" runat="server">#Maybank</label><br />
                                    <label id="lblToUsername" runat="server">#Channel</label><br />
