<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="IpTool.aspx.vb" Inherits="Admin_IpTool" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="admincontent" runat="Server">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">IP Lookup</h1>

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">IP Lookup</h6>
            </div>
            <div class="card-body">
