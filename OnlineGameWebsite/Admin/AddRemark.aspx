<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddRemark.aspx.vb" Inherits="Admin_AddRemark" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="admincontent" Runat="Server">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Add Remark</h1>
                ...
                <div class="col-lg-12">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Add New Remark</h6>
                        </div>
                        <div class="card-body">
