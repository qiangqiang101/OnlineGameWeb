                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="fileUploader" id="fileUploaderLabel" runat="server">Select product image file</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="button" class="btn btn-primary btn-user btn-block" onclick="window.location = 'Products.aspx'" value="Go Back" />
                            </div>
                        </div>
                    </div>
                </div>
