<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="EditRejectReason.aspx.vb" Inherits="Admin_EditRejectReason" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="admincontent" runat="Server">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Reject Reason</h1>
            ...
            <div class="col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary" id="h6" runat="server">Reject Reason</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="button" class="btn btn-primary btn-user btn-block" onclick="window.location = 'RejectReasons.aspx'" value="Go Back" />
                            </div>
                        </div>
                    </div>
                </div>
