<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AddBank.aspx.vb" Inherits="Admin_AddBank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="admincontent" Runat="Server">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Add Bank</h1>
