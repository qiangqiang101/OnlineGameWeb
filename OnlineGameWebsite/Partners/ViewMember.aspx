<%@ Page Title="" Language="VB" MasterPageFile="~/Partners/PartnersMaster.master" AutoEventWireup="true" CodeFile="ViewMember.aspx.vb" Inherits="Partners_ViewMember" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="admincontent" Runat="Server">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800" id="h1" runat="server">Member View</h1>
