	...
	function init_template(){        
       ...
       $(".text-size-default").click(function() {$(".text-size-changer *").css("font-size", "");});
        ...
        setTimeout(function(){
            ...
            $('.news-slider').owlCarousel({rtl:true, loop:true, margin:20, nav:false, stagePadding:30, lazyLoad:true, items:5, autoplay: false, dots:false, autoplayTimeout:4000});		
            $('.topic-slider').owlCarousel({rtl:true, loop:true, margin:0, nav:false, stagePadding:40, lazyLoad:true, items:2, autoWidth:true, autoplay: false, dots:false, autoplayTimeout:4000});		
            $('.story-slider').owlCarousel({rtl:true, loop:true, margin:20, nav:false, stagePadding:30, lazyLoad:true, items:4, autoplay: false, dots:false, autoplayTimeout:4000});		
            ...
            $('.fast-slider').owlCarousel({rtl:true, loop:true, margin:20, nav:false, lazyLoad:true, items:1, autoplay: true, autoplayTimeout:2000});		
            $('.boxed-slider').owlCarousel({rtl:true, loop:true, margin:20, stagePadding:50, nav:false, lazyLoad:true, items:1, autoplay: false, autoplayTimeout:4000});		
            $('.card-slider').owlCarousel({rtl:true, loop:true, margin:20, nav:false, lazyLoad:true, stagePadding:50, items:1, autoplay: true, autoplayTimeout:4000});		
            $('.cover-slider').owlCarousel({rtl:true, loop:false, margin:0, nav:false, lazyLoad:true, items:1, autoplay: true, autoplayTimeout:6000});		
            $('.double-slider').owlCarousel({rtl:true, loop: true, stagePadding:20, margin: 23, nav: false, items: 2,  dots: false});		
